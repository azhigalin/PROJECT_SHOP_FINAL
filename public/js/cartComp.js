  ...
  template: `<li class="cart__item">
                    <div class="cart__item-box1">
                        <div class="cart__img-box">
                            <img class="cart__img" :src="cartItem.img" alt="Product img" />
                        </div>
...
const cart = {
  ...
  methods: {
    ...
    cleanCart() {
      this.$parent.cleanJson(`/api/cart`).then((data) => {
        data.contents = [];
        this.cart = [];
      });
    },
  ...
  template: `
  <div>
  <button class="cart__button" type="button" @click="show=!show">
  <svg
  ...
  <ul class="cart__list" v-show="show">
                    <li class="cart__item">
                        <h2 class="cart__item-heading">Ваша корзина</h2>
                        <button class="cart_btn_clean" @click="cleanCart()">Очистить все</button>
                      </li>
                    <li class="cart__item" v-if="!cart.length">
